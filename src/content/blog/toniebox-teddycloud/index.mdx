...
date: 2025-01-20
tags: ['docker', 'toniebox', 'teddycloud', 'media', 'hardware', 'esp32']
image: './teddycloud.png'
authors: ['tobias']
---

## 1. Intro 

Die Tomaten aus meinem eigenen **Garten** schmecken immer besser als die aus dem Supermarkt. Das ist einfach so.
...
**Selbsthosting** kann man mit dem **Gärtnern** vergleichen. Ich habe die Dinge selbst in der Hand und wenn etwas nicht läuft, kümmere ich mich selber darum.
...
Ja, sie funkt schön fleißig alles in die Firmen-Cloud, was mein Kind so damit macht. Jede Bewegung der Box, jeder Figur wechseln, die Veränderung der Lautstärke, alles wird überwacht. **Das ist nicht wirklich cool.**
...
Jetzt hat unser Kind hat einen Radio-Tonie, der die "Sendung mit der Maus"-Radio-Sendung startet.
