...
## 1. Intro
Ich finde es ziemlich praktisch, wenn man Texte oder E-Mails mit einer Korrektur-Lesung kann. So kann ich im Fokus bleiben und muss nicht auf Groß- und Klein-Schreibung achten. Kleine Vertippe stören mich nicht, und am Ende mache ich `Ctrl+C` in ChatGPT lassen es korrigieren lesen und mache dann wieder `Ctrl+V` in z.B. meinem Thunderbird.
...
Ich zeige dir, wie du es in Thunderbird einbindest und wie du damit deine Texte oder E-Mails korrigieren kannst, ohne auf Groß- und Klein-Schreibung achten zu müssen.
...
### 2.1 Konfiguration für Thunderbird-Zugriff auf Ollama unter Linux
