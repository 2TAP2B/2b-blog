---
title: 'Seafile mit Docker installieren'
...
date: 2025-01-08
tags: ['docker', 'Seafile', 'Linux', 'Cloud-Storage', 'Sync']
image: './seafile.png'
authors: ['tobias']
---
...
In einer Welt, in der Daten immer wichtiger werden, ist es wichtig, dass wir unsere eigenen Daten kontrollieren können.
Wir müssen uns nicht auf kommerzielle Cloud-Anbieter verlassen, sondern eine Lösung finden, die unsere Privatsphäre und Sicherheit schützt.
Seafile ist eine beliebte Open-Source-Lösung für Dateisynchronisation und Cloud-Storage, die es ermöglicht, Dateien auf einem eigenen Server zu 
speichern und auf verschiedenen Geräten abzurufen. 
Mit dieser Lösung können wir unsere Daten sicher und effizient verwalten, ohne dass wir uns auf die Risiken und Einschränkungen 
von kommerziellen Cloud-Anbietern begeben müssen. 
...
- [Basic Server Setup](/blog/server-setup)
...
SEAFILE_SERVER_HOSTNAME=seafile.dein.server.de
